...
for i in ${!paths[@]}; do
    ...
    python3 $HOME/l0_ringer/src/eds_parser/create_jobs.py -i ${paths[$i]} -o $HOME/l0_ringer/data/data_$i/cells.csv -j $HOME/l0_ringer/data/data_$i/jobs/
    nohup python3 $HOME/l0_ringer/src/eds_parser/convert_eds.py -j $HOME/l0_ringer/data/data_$i/jobs/ > $HOME/l0_ringer/data/data_$i/log.txt &
done